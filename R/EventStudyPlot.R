...
#' # OLS
#'
#'eventstudy_estimates_ols <- EventStudy(estimator = "OLS", data = df_sample_dynamic,
#'outcomevar = "y_base",
...
#' # IV
#'
#'eventstudy_estimates_fhs <- EventStudy(estimator = "FHS", data = df_sample_dynamic,
#'outcomevar = "y_base",
#'policyvar = "z", idvar = "id", timevar = "t",
#'controls = "x_r", FE = TRUE, TFE = TRUE,
#'post = 3, pre = 0, overidpre = 3, overidpost = 1, normalize = - 1, cluster = TRUE, proxy = "eta_m")
#'
