...
We use the function `FindOrder`, already incorporated in the main `eventstudyr` package.
...
Now that we know the order of the desired polynomial, we want to find the smoothest path by solving the following problem:
