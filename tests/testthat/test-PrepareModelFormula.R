...
test_that("outcomevar is the dependent variable", {
  ...
  reg             <- PrepareModelFormula(outcomevar, str_policy_fd, str_policy_lead, str_policy_lag, controls)
  expect_equal(all.vars(reg)[1], outcomevar)
})

test_that("formula does not have an intercept", {
...
test_that("str_policy_fd arguments are incorporated into formula", {
...
test_that("str_policy_lead arguments are incorporated into formula", {
...
test_that("str_policy_lag arguments are incorporated into formula", {
...
test_that("controls arguments are incorporated into formula", {
  outcomevar        <- "y_base"
  str_policy_fd     <-  c("z_fd_lead1", "z_fd_lead2", "z_fd_lead4",
                          "z_fd_lead5", "z_fd_lead6", "z_fd_lag1", "z_fd_lag2",
                          "z_fd_lag3", "z_fd_lag4", "z_fd_lag5", "z_fd_lag6", "z_fd_lag7")
