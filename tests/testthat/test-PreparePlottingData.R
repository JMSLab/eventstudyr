...
test_that("labels are unique", {
    ...
    list_EventStudy <- EventStudy(estimator = "OLS", kernel = "estimatr", data = example_data, outcomevar = "y_base",
...
test_that("all columns besides 'term' and 'label' are 0 for the proxyIV column", {
    ...
    list_EventStudy <- EventStudy(estimator = "FHS", kernel = "estimatr", data = example_data, outcomevar = "y_base",
                                  policyvar = "z", idvar = "id", timevar = "t",
